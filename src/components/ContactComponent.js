                    ...
                    <div className="col-12 col-md-9">
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" id="telnum" name="telnum" placeholder="Tel. Number" className="form-control" />                                </Col>
                            </Row>
                            <Row className="form-group">
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".message" rows="12" id="message" name="message" className="form-control" />
                                </Col>
                            </Row>
                            <Row className="form-group">
